...
qtCreatorFile = "Prog_09_DespliegaContactos.ui" # Nombre del archivo aqui
...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def desplegarContacto(self):
         if(len(self.contactos)>0): #si hay elementos en el archivo
            self.txt_nombre.setText(self.contactos[self.posContactoActual][0]) #self.posContactoActual le agregamos uno para que vaya recorriendo
